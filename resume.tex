...
\resumeSubHeadingListStart
    ...
    \resumeProject
      {process engineering principles } %Project Name
...
\section{Key Courses Taken}
 \resumeHeadingSkillStart
  \resumeSubItem{} % Category
    {Chemical Reaction Engineering(UG),Transport Phenomena(PG),Thermodynamics(PG),Process Design and Control (UG),Mass Transfer and operations(UG),Heat Transfer(UG),Process Engg. principles in micro fabrication(PG),Computer Aided Process Equipment design and drawing(UG)}
