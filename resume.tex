...
\resumeSubHeadingListStart
    ...
    \resumeProject
      ...
      {Developed the graphical relation using MATLAB to analyse the effects of temperature,pressure and gas flow rate on the growth rate of oxide to model the process of "Gallium Oxide is grown over sapphire in a LPCVD reactor" } %Project Name, Location Name
...
\section{Key Courses Taken}
 \resumeHeadingSkillStart
  \resumeSubItem{} % Category
    {Chemical Reaction Engineering(UG),Transport Phenomena(PG),Thermodynamics(PG),Process Dynamics and Control (UG),Mass Transfer and operations(UG),Heat Transfer(UG),Process Engg. principles in micro fabrication(PG),Computer Aided Process Equipment design and drawing(UG)}
...
\resumePOR{Teaching Assistant,Chemical Engineering IIT Kanpur,Jeet Bindra Unit Operations Laboratory} % Position
    {Assisted,Drafted and evaluated theoritical and practical aspects of dynamics of certain processes of UG students.} %Club,Event
    {Present} %Tenure Period
\resumePOR{Event Head,} % Position
